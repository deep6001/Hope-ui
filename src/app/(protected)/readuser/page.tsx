...
const products = [
  ...
  },
  {
    ...
    Description: "classNameic novel by F. Scott Fitzgerald",
    Price: 12,
    CustomDetails: [
      {
        Date: "2023-09-02",
  ...
  },
  {
    ...
    Description: "classNameic novel by Harper Lee",
    Price: 15,
    CustomDetails: [
      {
        Date: "2023-09-10",
  ...
  },
  {
    ...
    Description: "classNameic novel by J.D. Salinger",
    Price: 10,
    CustomDetails: [
      {
        Date: "2023-09-14",
...
const TableReact = () => {
  ...
  useMemo(() => {
    const pages = Array(Math.ceil((productList?.length || 0) / rowsLimit)).fill(null);
    setCustomPagination(pages); // now valid if type is null[]
  ...
  return (
    ...
    <div className=" h-full bg-white flex  items-center justify-center pt-5 pb-14">
